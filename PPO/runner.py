...
from PPO.a2c_agent import A2CAgent
from PPO.network import FullyConv
from PPO.utils import get_state, get_action
...
with sc2_env.SC2Env(agent_race=None,
    ...
    for e in range(MAX_EPISODES):
        ...
        for time in range(MAX_STEPS):
            ...
            agent.append_sample(state, a, reward,point,preds)
            state = next_state
            obs = next_obs
            if done:
                print("episode: {}/{}, score: {}"
